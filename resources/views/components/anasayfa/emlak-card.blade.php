...
<a href="{{  route(app()->getLocale().'.emlakdetay', ['slug' => $emlak->detay->sef, 'id' => $emlak->id]) }}" 
...
<div class="relative flex flex-col justify-center items-start bg-blue-600 rounded-t-xl">
