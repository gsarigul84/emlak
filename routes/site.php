...
Route::get('/emlak-detay/{slug}', [EmlakdetayController::class, 'detay'])->name('emlakdetay');
Route::get('/blog/{slug}', [BlogController::class, 'index'])->name('blog');
Route::get('/post/{slug}', [PostController::class, 'detay'])->name('post');
});
...
Route::get('/details/{slug}', [EmlakdetayController::class, 'detay'])->name('emlakdetay');
Route::get('/blog/{slug}', [BlogController::class, 'index'])->name('blog');
Route::get('/post/{slug}', [PostController::class, 'detay'])->name('post');
});
});
